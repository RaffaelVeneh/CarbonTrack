  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-emerald-50/10 to-blue-50/20 flex">
      ...
      <main className="flex-1 ml-64 p-8">
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1 font-medium">Jejak langkahmu dalam menjaga bumi 🌍</p>
                  </div>
                </div>
        ...
        {/* Time Filter Buttons */}
        <div className="mb-6">
          <div className="bg-white p-2 rounded-2xl shadow-sm border border-gray-200 inline-flex gap-1">
            {filters.map((f) => {
              const Icon = f.icon;
              return (
                <button
            ...
            <div className="flex flex-col lg:flex-row gap-3">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-10 py-3 border-2 border-gray-200 rounded-xl focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100 outline-none transition-all"
                />
                {searchQuery && (
                  <button
              ...
              <select
                ...
                className="px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100 outline-none transition-all font-medium"
              >
              ...
              <button
                ...
                className="px-4 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition-all font-medium flex items-center gap-2"
              >
        ...
        <div className="space-y-3">
          {loading ? (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-16 text-center">
              ...
              <p className="mt-6 text-gray-500 font-medium">Memuat riwayat aktivitas...</p>
            ...
            <>
              ...
              <div className="flex items-center justify-between mb-4">
                <p className="text-sm text-gray-600 font-medium">
                  Menampilkan <span className="font-bold text-emerald-600">{filteredAndSortedLogs.length}</span> aktivitas
                      ...
                      <div className="border-t border-gray-100 px-5 py-4 bg-gray-50">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                          <div className="bg-white p-3 rounded-lg border border-gray-200">
                            <p className="text-xs text-gray-500 mb-1">Tanggal Lengkap</p>
                            <p className="font-semibold text-sm text-gray-800">{formatDate(log.date)}</p>
                          </div>
                          <div className="bg-white p-3 rounded-lg border border-gray-200">
                            <p className="text-xs text-gray-500 mb-1">Waktu</p>
                            <p className="font-semibold text-sm text-gray-800">{formatTime(log.created_at || log.date)}</p>
                          </div>
                          <div className="bg-white p-3 rounded-lg border border-gray-200">
                            <p className="text-xs text-gray-500 mb-1">Jumlah Input</p>
                            <p className="font-semibold text-sm text-gray-800">{log.input_value} {log.unit}</p>
                          </div>
                          <div className="bg-white p-3 rounded-lg border border-gray-200">
                            <p className="text-xs text-gray-500 mb-1">Emission Factor</p>
                            <p className="font-semibold text-sm text-gray-800">{log.emission_factor || 'N/A'}</p>
                          </div>
                        </div>
                      </div>
                    )}
